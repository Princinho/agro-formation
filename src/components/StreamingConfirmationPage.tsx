...
function readOrderFromUrl(): OrderDetails {
  ...
  return {
    ...
    orderRef:
      ...
      "",
    amount: params.get("amount") ?? "32 800",
      ...
      <div className="confirm-summary__header">
        <div>
          ...
          <h2 className="confirm-summary__product-name">
            Formation en streaming
          </h2>
          <div className="confirm-summary__badges">            
            <span className="badge badge--streaming">💻 Pass Streaming</span>
          </div>
        </div>

        <div className="confirm-summary__price-block">
          <div className="confirm-summary__price-original">45000 FCFA</div>
...
function ShareSection({ onCopy }: { onCopy: () => void }) {
  const shareText =
    "Je participe à la formation « L'Agrobusiness rentable au Togo » par Apélété ADOUKONOU —  Streaming, 09 Mai 2026. 🌱 Rejoins-moi : https://dcaqaymu.mychariow.shop/prd_ae2gfq";
...
// ─── Main Page ────────────────────────────────────────────────────
export default function StreamingConfirmationPage() {
